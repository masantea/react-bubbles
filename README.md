...
* Tokens, are strings of cryptic text issued by the server, which can be stored on the client-side using local storage or session storage. You get tokens in return of putting in correct credentials. 


- [ ] What steps can you take in your web apps to keep your data secure?

* Use protected routes that will only render with authentication, also use authentication headers with API calls. 

- [ ] Describe how web servers work.

* A web server stores, processes and delivers web pages to clients. It provides authentication tokens in exchange for correct login credentials. 
